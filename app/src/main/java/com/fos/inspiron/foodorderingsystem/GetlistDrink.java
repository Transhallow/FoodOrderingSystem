 ...
 */
public class GetlistDrink extends BaseAdapter {
    ...
    public GetlistDrink(JSONArray jsonArray, Activity a){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final ListCell cell;
        if(convertView == null){
            convertView= inflator.inflate(R.layout.get_all_drink,null);
                    cell= new ListCell();
